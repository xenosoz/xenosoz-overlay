...
# $Header: /var/cvsroot/gentoo-x86/sys-libs/timezone-data/timezone-data-2013a.ebuild,v 1.1 2013/03/03 01:54:25 vapier Exp $
...
src_compile() {
	local LDLIBS
	tc-export CC
	(use elibc_FreeBSD || use elibc_Darwin) && append-flags -DSTD_INSPIRED #138251
